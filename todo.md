...
- [ ] Implement auth flows (register/login) and protect user-specific endpoints.
...
- [ ] Wire login/register pages to real auth endpoints.
...
- [ ] Ensure CI runs lint, typecheck, and format checks.
